...
class PaginationService
{
    ...
    public function getPages(): int
    {
        ...
        //2) Faire la division, l'arrondi et la renvoyer
    ...
    public function getData()
    {
        if(empty($this->entityClass))
        {
            throw new \Exception("Vous n'avez pas spécifié l'entité sur laquelle nous devons paginer ! Utilisez la methode setEntityClass() de votre objet PaginationsService !"); 
        }
        //1)Calculer l'offset
